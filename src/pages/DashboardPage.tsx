					...
					<main className="space-y-8">
						...
						<Tabs defaultValue="processes" className="space-y-6">
							<TabsList className="grid w-full grid-cols-3 bg-muted/50">
								<TabsTrigger value="processes" className="data-[state=active]:bg-background">Processes</TabsTrigger>
								<TabsTrigger value="queues" className="data-[state=active]:bg-background">Queues</TabsTrigger>
							...
							<TabsContent value="processes" className="space-y-6">
								...
								{processesLoading ? (
									<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
										{[1, 2, 3].map((i) => (
											<div key={i} className="h-64 bg-muted/50 animate-pulse rounded-lg border" />
										))}
									</div>
								) : (
									<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
							...
							<TabsContent value="queues" className="space-y-6">
								...
								{queuesLoading ? (
									<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
										{[1, 2, 3].map((i) => (
											<div key={i} className="h-80 bg-muted/50 animate-pulse rounded-lg border" />
										))}
									</div>
								) : (
									<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
							...
							<TabsContent value="tasks" className="space-y-6">
								...
								{tasksLoading ? (
									<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
										{[1, 2, 3].map((i) => (
											<div key={i} className="h-72 bg-muted/50 animate-pulse rounded-lg border" />
										))}
									</div>
								) : (
									<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
